  ...
  die ('Can\'t use db : ' . mysqli_error());
	...
	if(isset($_GET['accesskey'])) {
		...
		if($access_key_received == $access_key){
			...
			$sql_query="SELECT et.*,dc.name FROM bsl.users_devices as ud join event as et on et.object=ud.devices_id join devices as dc on dc.id=ud.devices_id where ud.users_id='$user' and et.status=0 order by et.id desc limit 10;  ";
