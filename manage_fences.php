...
$result = mysqli_query($db,"SELECT geo.*,gt.type as type_name FROM bsl.geofenceing as geo left join geofence_type gt on gt.id=geo.geotype;");
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="edit_geofence.php?id=<?php echo $row['id']; ?>" target="_blank"><i class="fas fa-pencil-alt text-success" ></i></a></td>
