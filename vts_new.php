...
<body>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">VTS Monthly Report
                                            </a>
                                        </li>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel" id='title_edit'>Monthly VTS Report</h5>
...
<script>
    ...
    $(document).ready(function () {
        var dateString = "<?php echo ISSET($_GET['from']); ?>";
        var date = new Date(dateString);

        // Get the month as a zero-indexed integer
    ...
    function get_history() {
        ...
        if ($('#check').is(":checked")) {
            ...
            // alert(selected);
            window.location.href = "vts_new.php?asset=" + selected + "&from=" + from1 + "&to=" + to;
            // alert('Check');
        }
        else {
            window.location.href = "vts_new.php?vehicle=" + vehi_id + "&from=" + from1 + "&to=" + to;
