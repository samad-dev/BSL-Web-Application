...
<script>
    ...
    function get_history() {
        ...
        console.log("http://119.160.107.173:3002/positions3/" + vehi_id + "/" + from1 + "/" + to + "");
        var table1 = $('#example').DataTable({
                    "ajax": "http://119.160.107.173:3002/positions3/" + vehi_id + "/" + from1 + "/" + to + "",
                    "columns": [
                        {
                            "data": "GpsTime",
                            "render": function(data) {
                                return  moment(data).format(format1);
                            }
                        },
                        {
                            "data": "SPEED"
        ...
        //     $.ajax({
        //         url: 'http://119.160.107.173:3002/history/' + vehi_id + '/' + from1 + '/' + to + '',
        //         type: 'GET',
        //         beforeSend: function () {
        //             // $('#insert').val("Updating");
