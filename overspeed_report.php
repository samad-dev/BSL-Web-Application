...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Violation Report</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Violation Report</a>
                                        </li>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            if ($response != null) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Excess Idle Time</td>
                                                    <td>
                                                        <?php echo $response[0]['Excess_Idle_Time']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $response[0]['Harsh Acceleration']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Harsh Cornering</td>
                                                    <td>
                                                        <?php echo $response[0]['Harsh Cornering']; ?>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel" id='title_edit'>Create Violation Report</h5>
...
<script>
    ...
    function get_history() {
        ...
        var chkPassport1 = document.getElementById("check").value;
        ...
        if ($('#check').is(":checked")) {
            ...
            // alert(selected);
            window.location.href = "overspeed_report.php?asset=" + selected + "&from=" + from + "&to=" + to;
            // alert('Check');
        }
        else {
            const format1 = "YYYY-MM-DD HH:mm:ss";
            ...
            window.location.href = "overspeed_report.php?vehicle=" + vehi_id + "&from=" + from + "&to=" + to;
        }
