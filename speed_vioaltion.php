...
<head>
    ...
    <meta charset="utf-8" />
    <title>Speed Violation Report | BSL</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Speed Violation Report Template" name="description" />
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Speed Violation Report</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Speed Violation
                                                Report</a>
                                        </li>
                                        <li class="breadcrumb-item active">Speed Violation Report</li>
                                    </ol>
                                </div>
                    ...
                    <div class="row my-4">
                        <div class="col-md-2">
                            <button class="btn marron_bg" id='add' type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><i class="fas fa-search"></i></button>
                            ...
                            <table id="example" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        <!-- <th>S.No</th> -->
                                        <th>Vehicle</th>
                                        <th>Violation Start Time</th>
                                        <th>Violation End Time</th>
                                        <th>Max Speed</th>
                                        <th>Duration</th>
                                        <th>Location</th>
                                    </tr>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel" id='title_edit'>Create Speed Violation Report</h5>
                        ...
                        <form method="post" id="insert_form" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="form-control" data-trigger name="vehi_id[]" id="vehi_id" placeholder="Search Asset" required>
                            ...
                            <div class="mb-3 text-center">
                                <button type="button" class="btn marron_bg" id="drawing" onclick="get_history()">Get</button>
...
<script>
    ...
    function get_history() {
        ...
        console.log("http://119.160.107.173:3002/speed_v/" + vehi_id + "/" + from1 + "/" + to + "/" + interval + "");
        if (vehi_id != "" && from1 != "") {
            console.log('http://119.160.107.173:3002/speed_v/' + vehi_id + '/' + from1 + '/' + to + '');
            $.ajax({
                url: 'http://119.160.107.173:3002/speed_v/' + vehi_id + '/' + from1 + '/' + to + '/' + interval + '',
                type: 'GET',
                beforeSend: function() {
                    // $('#insert').val("Updating");
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                "render": function(data, type, row) {
                                    // Calculate the difference between StartVoilation and EndVoilation
                                    var duration = moment.duration(data.differ);
