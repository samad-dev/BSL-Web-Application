...
<head>
    ...
    <meta charset="utf-8" />
    <title>NR Report | BSL</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & NR Report Template" name="description" />
...
$result = mysqli_query($db,"SELECT * FROM `devices` as pos join users_devices ud on pos.id = ud.devices_id where  pos.time <='$prev_date' and ud.users_id = '$user_id'");
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">NR Report</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">NR Report</a></li>
                                        <li class="breadcrumb-item active">NR Report</li>
                                    </ol>
                                </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel" id='title_edit'>Add NR Report</h5>
