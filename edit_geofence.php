                            ...
                            <form method="post" id="insert_form" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control " id="name" name="name" value="<?php echo $data['consignee_name'] ?>" required>
                                    </div>

                                    <div class="col-md-12">
                                        <label class="form-label">Co-ordinates</label>
                                        <input type="text" class="form-control " id="lati" name="lati" required value="<?php echo $data['Coordinates'] ?>"
                                            readonly>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="inputAddress">Geo Type</label>

                                        <select class="form-control all_select" name="geotype" id="geotype"
                                    ...
                                    <input type="hidden" class="form-control input" id="radius" name="radius" value="<?php echo $data['radius'] ?>" required>
                                    <input type="hidden" class="form-control input" id="type" name="type" value="<?php echo $data['type'] ?>"
                                ...
                                <input type="hidden" name="employee_id" id="employee_id" value="<?php echo $data['id'] ?>">
...
<script>
    $(document).ready(function () {
        ...
        $('#geotype').val("<?php echo $data['geotype'] ?>").change();
    });
</script>
    ...
    function initMap() {
        ...
        if (geo_type != "polygon") {
            const cityCircle = new google.maps.Circle({
                ...
                radius: parseFloat("<?php echo $data['radius'] ?>"),
                clickable: false,
                editable: true,
                zIndex: 1,
                draggable: true,
