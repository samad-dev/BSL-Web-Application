...
$all_devices = mysqli_query($db, "SELECT dc.name,dc.latestPosition_id,dc.tracker as vehicle_make,dc.time,dc.speed,dc.location as vlocation ,dc.lat as latitude,dc.lng as longitude FROM users_devices as ud 
...
$access_driving = mysqli_query($db, "SELECT da.*,dc.name FROM bsl.axcess_driving_alerts as da 
join devices as dc on dc.id=da.vehicle_id 
where da.type='1' and DATE(da.created_at) >= DATE('$from' - INTERVAL 1 DAY) and da.created_at<='$to' and da.created_by='$id';");
$count_access_driving = mysqli_num_rows($access_driving);
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control " id="from" name="from" required value='<?php echo $_GET['from'] ?>'>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">To</label>
                            <input type="date" class="form-control " id="to" name="to" required value='<?php echo $_GET['to'] ?>'>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block">Total
                                                Vehicles</span>
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_all_devices; ?>">0</span>
                                            </h3>
                                        </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block">Vehicles Currently
                                                Moving</span>
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_moving_devices; ?>">0</span>
                                            </h3>
                                        </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block ">Vehicles Currently
                                                Stopped</span>
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_stop_devices; ?>">0</span>
                                            </h3>
                                        </div>
                                ...
                                <div class="card-body" data-id='idle_vehi_card' style="background-color: #e6b730;">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_idle_devices; ?>">0</span>
                                            </h3>
                                        </div>
                                ...
                                <div class="card-body" data-id='nr_vehi_card' style="background-color: #c24e9d;">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_nr_devices; ?>">0</span>
                                            </h3>
                                        </div>
                                ...
                                <div class="card-body" data-id='harsh_breaking' style="background-color: #668b67;">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_harsh_break; ?>">0</span>
                                            </h3>
                                        </div>
                                ...
                                <div class="card-body" data-id='harsh_acce' style="background-color: #935c5c;">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_harsh_acc; ?>">0</span>
                                            </h3>
                                        </div>
                                ...
                                <div class="card-body" data-id='harsh_corner' style="background-color: #90935c;">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_harsh_corner; ?>">0</span>
                                            </h3>
                                        </div>
                                ...
                                <div class="card-body" data-id='geofence_in' style="background-color: #5c0072;">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_geo_check_in; ?>">0</span>
                                            </h3>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6" id="dash_night_voilation">
                            ...
                            <div class="card card-h-100">
                                ...
                                <div class="card-body" data-id='night_voilation' style="background-color: #000;">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block">Night Driving Voilation</span>
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_night_voilation; ?>">0</span>
                                            </h3>
                                        </div>
                                ...
                                <div class="card-body" data-id='total_speed' style="background-color: #f00;">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_all_overspeed; ?>">0</span>
                                            </h3>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6" id="dash_un_auth_stop">
                            ...
                            <div class="card card-h-100">
                                ...
                                <div class="card-body" data-id='black_spot' style="background-color: #000;">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block">Un-Authorized Stops</span>
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_black_spot; ?>">0</span>
                                            </h3>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6" id="dash_ecess_driving">
                            ...
                            <div class="card card-h-100">
                                <!-- card body -->
                                <div class="card-body" data-id='access_day_driving' style="background-color: #cd6c6c;">
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            <span class="text-muted mb-3 lh-1 d-block">Excess Driving (per Day)</span>
                                            <h3 class="mb-3">
                                                <span class="counter-value text-light" data-target="<?php echo $count_access_driving; ?>">0</span>
                                            </h3>
                                        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="car_upper" style="background:#738599 !important ;  color: #fff;">
                                                <a href="check_alerts.php?id=<?php echo $row["latestPosition_id"]; ?>&geo=&type='Current Location'" target="_blank" style="  color: #fff;"><?php echo $row["name"]; ?></a>
                                            </td>
                                            <td>
                                                <?php echo $row["time"]; ?>
                                            </td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="check_alerts.php?id=<?php echo $row["msgid"]; ?>&geo=&type='Harsh Breaking'" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="check_alerts.php?id=<?php echo $row["msgid"]; ?>&geo=&type='Harsh Acceleration'" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity">
                                                        <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
                                                    </svg></a>
                                            </td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="check_alerts.php?id=<?php echo $row["msgid"]; ?>&geo=&type='Harsh Cornering'" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity">
                                                        <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
                                                    </svg></a>
                                            </td>
                        ...
                        <div class="col-md-12 device_listing d-none" id='night_voilation' style="overflow: auto;">
                            <h3>Night Driving Voilations </h3>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="check_night_voilation.php?id=<?php echo $_GET["id"]; ?>&time=<?php echo $row["created_at"]; ?>&veh_id=<?php echo $row["device_id"]; ?>&veh_name=<?php echo $row["name"]; ?>&type=<?php echo $row["type"]; ?>" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity">
                                                        <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
                                                    </svg></a>
                                            </td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="check_alerts.php?id=<?php echo $row["pos_id"]; ?>&geo=<?php echo $row["geo_id"]; ?>&type=<?php echo $row["type"]; ?>" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity">
                                                        <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
                                                    </svg></a>
                                            </td>
                        ...
                        <div class="col-md-12 device_listing d-none" id='access_day_driving' style="overflow: auto;">
                            <h3>Excess Driving (per Day) </h3>
                            <table id="example13" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th class="text-center">S.No</th>
                                        <th class="text-center">Name</th>
                                        <th class="text-center">Alert</th>
                                        <th class="text-center">Driving Limit</th>
                                        <th class="text-center">Drived (Per day)</th>
                                        <th class="text-center">Excess Driving </th>
                                ...
                                <tbody>
                                    <?php
                                    $i = 1;
                                    while ($row = mysqli_fetch_array($access_driving)) {
                                    ?>
                                        <tr>
                                            <td class="text-center">
                                                <?php echo $i ?>
                                            </td>
                                            <td style="background:#cd6c6c  !important ;  color: #fff;">
                                            ...
                                            <td class="text-center">
                                                <?php echo number_format(($row["driving_limit"] / 60), 2, '.', ''); ?> Hr
                                            </td>
                                            <td class="text-center">
                                                <?php echo number_format(($row["excess_driving"] / 60), 2, '.', ''); ?> Hr
                                            </td>
                                            <td class="text-center">
                                                <?php echo number_format(($row["duration"] / 60), 2, '.', ''); ?> Hr
                                            </td>
...
<script>
    $(document).ready(function() {
        ...
        $('.card-body').click(function(event) {
            ...
            $('.card-body').removeClass('card_updown')
            $('[data-id=' + id + ']').addClass('card_updown')
            console.log('id = ' + id);
        });
        ...
        var donutChart = {
            ...
            labels: ['Harsh Breaking', 'Harsh Acceleration', 'Harsh Cornering', 'Night Driving Voilation', 'Total Speed Voilation', 'Un-Authorized Stops'],
