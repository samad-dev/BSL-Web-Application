...
$location = $row_location["location"];
	...
	(course, latitude, longitude, speed, time, device_id, msgid, objectid, address)  
	VALUES 
	('$VectorAngle','$lat','$lng','$VectorSpeed','$timefinal','$ObjectId','$MessageId','$ObjectId','$location')") or die(mysqli_error($connection));
