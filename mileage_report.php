...
<head>
    ...
    <meta charset="utf-8" />
    <title>Mileage Report | BSL</title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Mileage Report</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Mileage Report</a>
                                        </li>
                                        <li class="breadcrumb-item active">Mileage Report</li>
                                    </ol>
                                </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel" id='title_edit'>Create Mileage Report</h5>
...
<script>
    ...
    function get_history() {
        ...
        if (vehi_id != "" && from != "") {
            console.log('http://119.160.107.173:3002/mileage/' + vehi_id + '/' + from + '/' + to + '');
            $.ajax({
                url: 'http://119.160.107.173:3002/mileage/' + vehi_id + '/' + from + '/' + to + '',
                type: 'GET',
                beforeSend: function () {
                    // $('#insert').val("Updating");
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            table
                                .row.add([
                                    (i + 1),
                                    vehi_name,
                                    moment(data[i].DateFrom).format(format1),
                                    moment(data[i].DateTo).format(format1),
                                    Math.round(data[i].Distance,2)+" KM",
                                    ]).draw().node();
                        }
                    } else {
                        alert("No Data Found");
