...
<head>
    ...
    <meta charset="utf-8" />
    <title>Alerts | BSL</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Alerts Template" name="description" />
...
$result = mysqli_query($db,"SELECT * FROM driving_alerts where created_at>='$prev_date' and created_by='$user_id' order by id desc ");
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-row mb-4 ">
                                    ...
                                    <div class="form-group col-md-4 offcanvas-body">
                                ...
                                <div class="mb-3 " style="text-align: right;">
                                    ...
                                    <input class="btn marron_bg" type="button" value="Get"  onclick="get_history()" >
                                </div>
                            </div>
                        </div>
                    </div>
